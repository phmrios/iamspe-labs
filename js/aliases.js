...
const ALIASES_HEMO = {
  ...
  hemoglobina: "Hb",
  hematocrito: "Ht",
  // Hemácias = eritrócitos — não exibimos na saída, mapeamos para null para ignorar
  hemacias: null,
  eritrocitos: null,
  vcm: "VCM",
  hcm: "HCM",
...
const MATERIAL_REGEX =
  /^(sangue|soro|urina|plasma|lcr|escarro|fezes|swab|liquor|liquido|medula|lavado|aspirado|tecido|cateter)/i;
